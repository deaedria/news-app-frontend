...
const Article = () => {
    ...
    return (
        <div>
            ...
            <section className="container sc-article-search">
                <div className="row search-result">
                    <div className="d-flex mt-4 justify-content-between wrap-category">
                        <h6>Search result for "{title}"</h6>
                    </div>
                </div>
            </section>

            <section>
                {/* <div className="d-flex filter container mt-4">
                    ...
                    <div className="filter-span">
                        Filter Article: sort by <strong>Name (A-Z)</strong>
                    </div>
                </div> */}
