...
const Article = (props) => {
    ...
    const { data: newsLastAdded } = useSWR(`${process.env.API_URI}article/last`, fetcherGet, { initialData: props.articleLastAdded })
            ...
            <section>
                <div className="d-flex filter container mt-3">
                    ...
                    <div className="filter-span">
                        Filter Article: sort by <strong>Last Added</strong>
                    </div>
                </div>
