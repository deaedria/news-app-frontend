...
const fetcherCreate = (url,data) => axios.post(url,data).then(result=>{
    return result.data.data
})
...
export {fetcherAuth, fetcherReg, fetcherGet, fetcherDelete, fetcherUpdate, fetcherCreate, fetcherLoggedIn, fetcherLogout}
